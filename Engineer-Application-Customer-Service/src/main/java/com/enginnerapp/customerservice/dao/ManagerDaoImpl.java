...
import com.enginnerapp.customerservice.dao.util.DBQueries;
...
{
	 	int res1 = jdbcTemplate.update(DBQueries.ADD_NEW_ACCOUNT,accountId,balance,customerId,branchId,roleType);
 ...
 @Override
	public List<AccountDetails> findAccountDetails() {
		...
		return jdbcTemplate.query(DBQueries.VIEW_ALL_ACCOUNT_INFO,(ResultSet rs)->{
