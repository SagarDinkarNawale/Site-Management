/*
 * package com.statebank.xoriant.resource; import java.util.Date; import
 ...
 * 
 * import es.softtek.jwtDemo.dto.User; import io.jsonwebtoken.Jwts; import
 ...
 * @PostMapping("user")
 * 
 * public User login(@RequestParam("user") String
 * username, @RequestParam("password") String pwd) {
 * 
 * String token = getJWTToken(username); User user = new User();
 * user.setUser(username); user.setToken(token); return user;
 * 
 * }
 * 
