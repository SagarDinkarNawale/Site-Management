...
import com.xoriant.managerservices.model.Gender;
import com.xoriant.managerservices.model.PersonInfo;
import com.xoriant.managerservices.model.Roles;
...
//	person_id, personName, gender, dob, phone_number, address_id, person_type
	...
	public String addCustomerPerform(@RequestParam("userId") String userId,
		...
		if (userId.equals("1")) {
			...
			PersonInfo personInfo = new PersonInfo(personName, gender, dateOfBirth, mobile, address, personType);
	...
	public String addAccountPerform(@RequestParam("userId") String userId, @RequestParam("customerId") int customerId,
			@RequestParam("balance") int balance, @RequestParam("branchId") int branchId,
		...
		if (userId.equals("1")) {
			...
			managerService.addAccount(userId, customerId, balance, branchId, accountType);
			// managerService.deleteCustomer(customerId);
	...
	public String deleteAccountPerform(
		...
		//get manager ID here
		if (userId.equals("1")) {
			managerService.deleteAccount(customerId, accountNumber, accountType);
