package com.xoriant.managerservices.dao.util;
...
public class DBQueries {
	...
	public static final String DELETE_CUSTOMER_Q0=" delete  from transaction_details where account_number=(select  account_number from account_details where customer_id=? limit 1);";
